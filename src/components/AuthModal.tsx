      ...
      {authModalOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed inset-4 sm:top-1/2 sm:left-1/2 sm:transform sm:-translate-x-1/2 sm:-translate-y-1/2 sm:inset-auto w-full sm:max-w-md bg-background rounded-lg shadow-elegant z-50 p-6 sm:p-8 max-h-[90vh] overflow-y-auto"
          >
